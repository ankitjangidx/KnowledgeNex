...
# KnowledgeNex Online Education Platform (MERN App) [Website Link](https://knowledgenex.vercel.app/)


![knowledgenex vercel app_](https://github.com/ankitjangidx/KnowledgeNex/assets/100501722/2063039b-5e7b-4607-bf33-f4efc273bbeb)

## Project Description

KnowledgeNex is a fully functional ed-tech platform that enables users to create, consume,
and rate educational content. The platform is built using the MERN stack, which includes
ReactJS, NodeJS, MongoDB, and ExpressJS.
KnowledgeNex aims to provide:
...
In summary, KnowledgeNex is a versatile and intuitive ed-tech platform that is designed to
...
The KnowledgeNex ed-tech platform consists of three main components: the front end, the
...
Here is a high-level diagram that illustrates the architecture of the KnowledgeNex ed-tech
platform:

![architecture](https://github.com/ankitjangidx/KnowledgeNex/assets/100501722/c21d3c77-b6d2-47ab-b2e1-030afaa87de0)

## Front End

The front end of KnowledgeNex has all the necessary pages that an ed-tech platform should
...
KnowledgeNex uses a monolithic architecture, with the backend built using Node.js and
Express.js, and MongoDB as the primary database. 

Features and Functionalities of the Back-end: 
The back end of KnowledgeNex provides a range of features and functionalities, including:
...
1. Cloud-based media management: KnowledgeNex uses Cloudinary, a cloud-based media
...
The back end of KnowledgeNex uses a range of frameworks, libraries, and tools to ensure its
...
The back end of KnowledgeNex uses a range of data models and database schemas to
...
Overall, the back-end of KnowledgeNex is designed to provide a robust and scalable solution
...
![schema](https://github.com/ankitjangidx/KnowledgeNex/assets/100501722/4c1240e9-5a51-4d23-9e0d-7310cdf1e3ea)

## API Design

The KnowledgeNex platform's API is designed following the REST architectural style. The
...
In conclusion, the REST API design for the KnowledgeNex ed-tech platform is a crucial part
...
what kind of data it will accept or return. With this API design, KnowledgeNex will be able to
